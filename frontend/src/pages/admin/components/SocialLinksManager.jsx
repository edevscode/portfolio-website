...
const SocialLinksManager = forwardRef(function SocialLinksManager({ embedded = false }, ref) {
  ...
  const handleAdd = () => {
    setFormData({ platform: '', url: '', icon: '', order: links.length, is_visible: true })
    setEditingId(null)
    setShowForm(true)
  }
  ...
  if (embedded) {
    return (
      <>
        <Table columns={columns} data={links} onEdit={handleEdit} onDelete={handleDelete} loading={loading} />
        {form}
      </>
    )
  }
